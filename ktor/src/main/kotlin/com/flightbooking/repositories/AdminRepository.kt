...
class AdminRepository {
    ...
    fun getFlightAvailabilityReport(
        ...
        toCodes: List<String>?,
        date: LocalDate?,
    ): List<FlightAvailabilitySummary> =
        transaction {
    ...
    fun updateFlightSchedule(
        flightId: Int,
        newDepartureAirportId: Int,
        newArrivalAirportId: Int,
    ...
    fun handleFlightInfoRequest(
        requestId: Int,
        newStatus: FlightInfoRequestStatus,
        adminReply: String?,
        adminUserId: Int,
    ): Boolean =
        transaction {
