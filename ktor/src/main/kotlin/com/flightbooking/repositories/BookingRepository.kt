        ...
        transaction {
            ...
            val seatNumber =
                TicketAssignmentTable
                    ...
                    .singleOrNull() ?: throw IllegalStateException("Outbound seat number found")

            val flightSeatId =
                TicketAssignmentTable
                    .select { TicketAssignmentTable.passengerId eq passenger.id }
                    .map { it[TicketAssignmentTable.flightSeatId] }
                    .singleOrNull() ?: throw IllegalStateException("Outbound flight seat id found")
        ...
        transaction {
            ...
            val returnFlightSeatId =
                TicketAssignmentTable
                    .select { TicketAssignmentTable.passengerId eq passenger.id }
                    .map { it[TicketAssignmentTable.flightSeatId] }
                    .singleOrNull() ?: throw IllegalStateException("Return flight seat id found")
